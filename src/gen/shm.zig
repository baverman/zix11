...
pub const Attach = struct {
    ...
    pub fn encode(self: @This(), writer: anytype) void {
        writer.writeInt(u32, @intFromEnum(self.shmseg));
...
pub const QueryVersionReply = struct {
    ...
    pub fn encode(self: @This(), writer: anytype) void {
        writer.writeByte(@intFromBool(self.shared_pixmaps));
        writer.writeInt(u16, self.major_version);
        writer.writeInt(u16, self.minor_version);
        writer.writeInt(u16, self.uid);
        writer.writeInt(u16, self.gid);
        writer.writeByte(self.pixmap_format);
...
pub const CompletionEvent = struct {
    ...
    pub fn toBytes(self: @This()) [32]u8 {
        ...
        self.drawable.encode(writer);
        writer.writeInt(u16, self.minor_event);
        writer.writeByte(self.major_event);
        writer.splatByte(0, 1);
        writer.writeInt(u32, @intFromEnum(self.shmseg));
        writer.writeInt(u32, self.offset);
        return packet;
